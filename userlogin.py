...
def get_doctor_login_info():
    #  获取基本数据
    login_key = httputil.geturl(const.HOST_GEN_LOGIN_KEY_URL,
                                data={'phoneNum': const.DOCTOR_PHONE}, headers=const.DEFAULT_HEADER)
    ...
    # 获得密码加密结果
    encrypted_pwd = httputil.geturl(const.HOST_ENCRYPTED_SERVER_URL, {'password': const.DOCTOR_PWD})
    # 开始登录
    login_parameter = {
